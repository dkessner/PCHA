...
* 2.3 Multiple angle formulas 
    ...
    - reference: OSP 7.3, DWFK 5.4, SZ 10.4
...
* 3.1 Vectors 
    ...
    - reference: OSP 8.8, DWFK 6.1, SZ 11.8
...
* 4.1 Function properties 
    ...
    - reference: OSP 1.1-1.3, DWFK 1.2-1.3, SZ 1.6

* 4.2 Operations, transformations, composition, inverses 
    - function operations
    - function composition and inverses
    - reference: OSP 1.4-1.5, DWFK 1.4-1.6, SZ 1.5, 1.7, 5.1, 5.2
...
* 4.3 Polynomials 1 
    ...
    - Remainder theorem
    - Factor theorem
    - reference: OSP 3.2-3.6, DWFK 2.1-2.2, SZ 3.1, 3.2

* 4.4 Polynomials 2, Complex numbers 
    - synthetic division
    - potential rational zeros
    - reference: OSP 3.5-3.6, 3.1, DWFK 2.3-2.4, P.6, SZ 3.3, 3.4
...
* 4.5 Complex numbers, Fundamental theorem of Algebra 
    ...
    - reference: OSP 3.6, DWFK P.6, 2.5, SZ 3.4
...
* 5.1 Parabolas 
    ...
    - reference: OSP 10.1, DWFK 8.1, SZ 7.3

* 5.2 Ellipses 
    - geometric definition
    - algebraic definition
    - graphing
    - reference: OSP 10.2, DWFK 8.1, SZ 7.4
...
* 6.5 Sequences 
    ...
    - explicit definition
    - limits
    - reference: OSP 11.1-11.3, DWFK 9.4, SZ 9.1
...
* 7.1 Exponential / logarithm 1 
    ...
    - reference: OSP 4.1-4.7, DWFK 3.1-3.4, SZ 6.1-6.5
...
* 8.4 Differentiation Rules 
    ...
    - reference: OSC1 3.2-3.3, FDWK 3.3
...
* 9.1 Chain rule 
    ...
    - reference: OSC1 3.6, FDWK 4.1

* 9.2 Implicit differentiation 
    - chain rule -> implicit differentiation
    - general power rule
    - reference: OSC1 3.8, FDWK 4.2
